...
class WeaponSwing:
    ...
    def rotate(self, weapon=None):
        ...
        if(self.swing_side == 1):
            ...
            angle,area135 = weaponAngle(angle135_mask,344,387,640,angle)
            angle,area165 = weaponAngle(angle165_mask,430,480,390,640,angle)
            angle,area195 = weaponAngle(angle195_mask,320,480,0,250,angle)
            angle,area225 = weaponAngle(angle225_mask,384,480,0,250,angle)
            angle,area255 = weaponAngle(angle255_mask,288,384,0,250,angle)
            angle,area285 = weaponAngle(angle285_mask,192,288,0,250,angle)
            angle,area315 = weaponAngle(angle315_mask,96,192,0,250,angle)
            angle,area345 = weaponAngle(angle345_mask,0,96,0,250,angle)             
            angle,area30 = weaponAngle(angle30_mask,43,86,390,640,self.angle)
            ...
            angle,area0 = weaponAngle(angle0_mask,0,160,250,390,angle)
            angle,area180 = weaponAngle(angle180_mask,320,480,0,250,angle)
            angle,area210 = weaponAngle(angle210_mask,384,480,0,250,angle)
            angle,area240 = weaponAngle(angle240_mask,288,384,0,250,angle)
            angle,area270 = weaponAngle(angle270_mask,192,288,0,250,angle)
            angle,area300 = weaponAngle(angle300_mask,96,192,0,250,angle)
            angle,area330 = weaponAngle(angle330_mask,0,96,0,250,angle)
            ...
            angle,area30 = weaponAngle(angle30_mask,0,96,426,640,self.angle)
            angle,area60 = weaponAngle(angle60_mask,96,192,426,640,angle)
            angle,area90 = weaponAngle(angle90_mask,192,288,426,640,angle)
            angle,area120 = weaponAngle(angle120_mask,288,384,426,640,angle)
            angle,area150 = weaponAngle(angle150_mask,384,480,426,640,angle)
            angle,area0 = weaponAngle(angle0_mask,0,160,213,426,angle)
            angle,area180 = weaponAngle(angle180_mask,320,480,213,426,angle)
            angle,area210 = weaponAngle(angle210_mask,384,480,0,213,angle)
            angle,area240 = weaponAngle(angle240_mask,288,384,0,213,angle)
            angle,area270 = weaponAngle(angle270_mask,192,288,0,213,angle)
            angle,area300 = weaponAngle(angle300_mask,96,192,0,213,angle)
            angle,area330 = weaponAngle(angle330_mask,0,96,0,213,angle)
