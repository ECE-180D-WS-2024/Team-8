...
class WeaponSwing:
    ...
    def rotate(self, weapon=None):
        ...
        if(self.swing_side == 1):
            ...
            angle,area75 = weaponAngle(angle75_mask,192,288,390,640,angle)
            angle,area105 = weaponAngle(angle105_mask,288,384,390,640,angle)
            angle,area135 = weaponAngle(angle135_mask,384,480,390,640,angle)
            angle,area165 = weaponAngle(angle165_mask,0,160,390,640,angle)
